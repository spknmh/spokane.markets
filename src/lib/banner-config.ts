...
export function parseBannerFocalValue(
...
export function createDefaultBannerImages(): Record<BannerKey, BannerImageConfig> {
  return {
    hero: {
      url: COMMUNITY_IMAGES.hero,
      focalX: DEFAULT_BANNER_FOCAL_X,
      focalY: DEFAULT_BANNER_FOCAL_Y,
      objectPosition: `${DEFAULT_BANNER_FOCAL_X}% ${DEFAULT_BANNER_FOCAL_Y}%`,
    },
    farmersMarket: {
